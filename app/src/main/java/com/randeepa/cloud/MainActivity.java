...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void signIn(final String username, final String password) {
        ...
        String url = "https://www.randeepa.cloud/android-api6/signin";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    boolean signinSuccess = Boolean.parseBoolean(signinRes.getString("status"));
                    String signinMessage = signinRes.getString("message");
                    ...
                    if(signinSuccess) {
                        ...
                        String sessionExep[] = {"status", "message"};

                        while(signinResIter.hasNext()) {
                            String key = signinResIter.next();
                            if(!Arrays.asList(sessionExep).contains(key)) {
                        ...
                        AlertDialog failureAlert = new AlertDialog.Builder(MainActivity.this).create();
                        failureAlert.setTitle("Sign in failed");
                        failureAlert.setMessage(signinMessage);
                        failureAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "OK",
                                new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
